...
export interface ProcessSection4Props {
  eyebrow?: string;
  titleLine1?: string;
  titleLine2?: string;
  subtitle?: string;
...
export default function ProcessSection4({
  eyebrow = defaultEyebrow,
  titleLine1 = defaultTitleLine1,
  titleLine2 = defaultTitleLine2,
  subtitle = defaultSubtitle,
  cards = defaultCards,
}: ProcessSection4Props): JSX.Element {
  const visibleCards = cards.slice(0, 8);

  return (
    <section className="process-section-4">
      <style>{`
        .process-section-4 * {
          margin: 0;
          padding: 0;
        ...
        .process-section-4 .container {
          max-width: 1278px;
          margin: 0 auto;
          padding: 78px 24px 72px;
        }

        .process-section-4 .header {
          max-width: 626px;
          margin: 0 auto;
          text-align: center;
        }

        .process-section-4 .eyebrow {
          color: #fe9a00;
          font-size: 14.302px;
          font-weight: 600;
        ...
        .process-section-4 .title-line-1 {
          margin-top: 19px;
          color: #ffffff;
          font-size: 64px;
          line-height: 1;
        ...
        .process-section-4 .title-line-2 {
          margin-top: 4px;
        ...
        .process-section-4 .card-content {
          position: absolute;
          left: 25px;
          right: 25px;
          bottom: 54px;
        ...
        .process-section-4 .card-description {
          margin-top: 18px;
          color: #ffffff;
          font-size: 16px;
          line-height: 18px;
